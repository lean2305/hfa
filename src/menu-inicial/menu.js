...
class Conteudo_menu extends Component{
    render() {
        return( 
            <div className='conteudo_menu_menu_inicial'>
               <img className='imgbarra_menu_inicial' src="https://showroom.portugalbikevalue.pt/wp-content/uploads/2021/05/HFA-Logo-Dark.png"  />  
...
class Botao extends Component{
    render() {
        return( 
            <div className='menu_botao_menu_inicial'>
            ...
            <div>
                <div className="quadrado_fila1_menu_inicial">
                    ...
                    <div style={{backgroundImage:"url('https://img.freepik.com/fotos-gratis/trabalhando-no-laptop_1098-18083.jpg')"}} className="quadrado_menor_menu_inicial">
                        ...
                        <h1 className="quadrado_h1_menu_inicial">Recrutamento</h1>
                    </div>
                    <div style={{backgroundImage:"url('https://s1.static.brasilescola.uol.com.br/be/vestibular/notebook-ferramenta-trabalho-varios-profissionais-599844f1a665d.jpg')"}} className="quadrado_menor_menu_inicial">
                        ...
                        <h1 className="quadrado_h1_menu_inicial">Historia HFA</h1>
                    </div>
                </div>
                <div className="quadrado_fila2_menu_inicial">
                    <div style={{backgroundImage:"url('https://s1.static.brasilescola.uol.com.br/be/vestibular/notebook-ferramenta-trabalho-varios-profissionais-599844f1a665d.jpg')"}} className="quadrado_menor_menu_inicial">
                        ...
                        <h1 className="quadrado_h1_menu_inicial">Videos</h1>
                    </div>
                    ...
                    <svg className="svg_maior_menu_inicial" width="20%" height="20%" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <Container>
                    <Row>
                        <Col sm={4}>
                            <div>
                                <Link to="/menu">
                                    <svg className='svg_menu_menu_inicial' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><path d="M0 96C0 78.3 14.3 64 32 64H416c17.7 0 32 14.3 32 32s-14.3 32-32 32H32C14.3 128 0 113.7 0 96zM0 256c0-17.7 14.3-32 32-32H416c17.7 0 32 14.3 32 32s-14.3 32-32 32H32c-17.7 0-32-14.3-32-32zM448 416c0 17.7-14.3 32-32 32H32c-17.7 0-32-14.3-32-32s14.3-32 32-32H416c17.7 0 32 14.3 32 32z"/></svg>
                                </Link>
                                    <p className='text_menu_menu_inicial'>MENU</p>
                            </div>
                        </Col>
                        <Col sm={4}>
                            <Clock />
