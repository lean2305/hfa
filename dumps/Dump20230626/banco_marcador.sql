...
CREATE TABLE `marcador` (
  ...
  `contacto_marcador` text NOT NULL,
...
INSERT INTO `marcador` VALUES (1,'Recursos Humanos','http://10.0.5.124/start'),(2,'Planeamento','http://10.0.5.124/start'),(3,'Compras','http://10.0.5.124/start');
